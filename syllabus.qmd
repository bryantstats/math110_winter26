...
-   *Assignments*: Tentatively, assignments will be completed during class, where you will have the opportunity to ask questions.

-   *Attendance*: Attendance will be taken at every class meeting. Regular attendance is essential—not only for earning attendance points, but also for successfully completing assignments.
